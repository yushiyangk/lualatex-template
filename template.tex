...
%% Software
% \usepackage{yushiyang-minted} % Provide source code environment with syntax highlighting (requires compiling with the -shell-escape option BEFORE the input file argument, and requires Python package Pygments; pip install Pygments)
